...
## Risks
- **Cache Invalidation**: If the cache gets out of sync (e.g. file edited externally without `lastModified` update - rare but possible), user might see stale data. *Mitigation*: Add a "Rebuild Index" button in Settings.
