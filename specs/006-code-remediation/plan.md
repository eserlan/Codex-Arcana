...
## Risks
- **Graph Stability:** Changes to the graph update logic might introduce edge cases where the graph *doesn't* update when it should. We need to test the "Connect Mode" and "Filter" scenarios carefully.
